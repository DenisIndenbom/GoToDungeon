def start_template(intro, genre, players):
    ...
    for i in range(len(players)):
        player = players[i]
        res += f"{i + 1} персонаж. Имя: {player['name']}. Биография: {player['bio']}.\n"
    res += """
        Опиши начальное окружение сохранённых персонажей исходя из жанра.
        Коротко опиши каждого персонажа и его способности.
        Обязательно дай игрокам достаточно сложное начальное задание или квест через случайного персонажа.
    """
